...
remzerovec
*linearize v(vco_out)
write tb_PLL_model_phase_noise.raw
wrdata /foss/designs/synchronos-chipathon-2026/designs/libs/scripts/sim_data/tb_PLL_model_phase_noise.txt tran.all
*fft v(vco_out)
...
descr="load tran" 
tclcommand="xschem raw_read $netlist_dir/tb_PLL_model_phase_noise.raw tran"
}
