...
C {lab_pin.sym} 960 -250 2 1 {name=p4 sig_type=std_logic lab=VOP}
C {lab_pin.sym} 960 -230 0 0 {name=p15 sig_type=std_logic lab=VON}
C {lab_pin.sym} 960 -210 0 0 {name=p16 sig_type=std_logic lab=VBN}
C {lab_pin.sym} 1260 -250 0 1 {name=p17 sig_type=std_logic lab=AVDD}
C {lab_pin.sym} 1260 -230 0 1 {name=p18 sig_type=std_logic lab=AVSS}
C {libs/core_analog/d2s_converter/d2s_converter.sym} 1110 -160 0 0 {name=x4}
C {lab_pin.sym} 960 -160 0 0 {name=p29 sig_type=std_logic lab=VOP}
C {lab_pin.sym} 960 -180 2 1 {name=p30 sig_type=std_logic lab=VON}
C {lab_pin.sym} 960 -140 0 0 {name=p31 sig_type=std_logic lab=VBN}
C {lab_pin.sym} 1260 -180 0 1 {name=p32 sig_type=std_logic lab=AVDD}
C {lab_pin.sym} 1260 -160 0 1 {name=p33 sig_type=std_logic lab=AVSS}
