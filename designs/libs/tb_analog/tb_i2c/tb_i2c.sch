...
F {}
E {}
N -160 340 -0 340 {lab=0}
N -240 280 -160 280 {lab=sda_oe}
N -280 240 -160 240 {lab=sda}
N -280 240 -280 250 {lab=sda}
N -310 280 -280 280 {lab=0}
N -280 340 -160 340 {lab=0}
N -280 310 -280 340 {lab=0}
N -310 310 -280 310 {lab=0}
...
.control
  ...
  * Plot 1: Input Stimulus (Notice SDA will dip slightly below 5V when ACK'd)
  plot v(scl)+12 v(sda)+6 v(sda_oe)
  * Plot 2: Output Bus (Using escaped brackets!)
...
C {libs/core_analog/I2C/i2c_target.sym} 0 200 0 0 {name=x2}
C {devices/lab_pin.sym} -180 280 0 0 {name=p19 sig_type=std_logic lab=sda_oe}
