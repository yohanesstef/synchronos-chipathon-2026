...
N 650 -1500 650 -1490 {lab=reference}
N 650 -1500 710 -1500 {lab=reference}
...
N 2250 -1330 2250 -1260 {lab=CK0}
N 1670 -1260 2250 -1260 {lab=CK0}
C {lab_wire.sym} 1370 -1260 0 0 {name=p3 sig_type=std_logic lab=div_out
}
C {lab_wire.sym} 670 -1500 0 0 {name=p4 sig_type=std_logic lab=reference}
...
descr="load tran 1" 
tclcommand="xschem raw_read $netlist_dir/tb_PLL_CP_VCO_model_N2_350MEG.raw tran"
}
...
.param f_ref=10k R_div=2 N_div=2
...
fft v(CK0)
write tb1_fft.raw
  *wrdata tl_synth_tb_long_2.txt v(vfout)
.endc
"}
...
descr="load tran 2" 
tclcommand="xschem raw_read $netlist_dir/tb_PLL_CP_VCO_model_R2_N255_255MEG_test.raw tran"
}
