...
space
tune"
rawfile=$netlist_dir/tb_PLL_div_model.raw
hilight_wave=-1
digital=1
y2=3}
...
N 620 -1300 630 -1300 {lab=0}
N 620 -1240 640 -1240 {lab=rst}
N 640 -1360 640 -1240 {lab=rst}
N 630 -1310 630 -1300 {lab=0}
N 590 -1310 630 -1310 {lab=0}
N 590 -1310 590 -1300 {lab=0}
N 620 -1500 640 -1500 {lab=reference}
N 1130 -1310 1150 -1310 {lab=rst}
N 1270 -1330 1270 -1260 {lab=vco_out}
N 1130 -1330 1270 -1330 {lab=vco_out}
N 680 -1230 810 -1230 {lab=div_out}
N 680 -1260 680 -1230 {lab=div_out}
N 1270 -1260 1670 -1260 {lab=vco_out}
N 1130 -1150 1130 -1130 {lab=VDD}
N 1130 -1210 1130 -1170 {lab=GND}
N 1130 -1270 1130 -1250 {lab=GND}
C {lab_wire.sym} 1740 -1500 0 1 {name=p2 sig_type=std_logic lab=vco_out
}
C {lab_wire.sym} 750 -1230 0 0 {name=p3 sig_type=std_logic lab=div_out
}
...
device=resistor
m=1}
C {lab_wire.sym} 1290 -1760 0 0 {name=p9 sig_type=std_logic lab=VDD}
...
C {devices/launcher.sym} 1950 -1090 0 0 {name=h2
descr="load tran" 
tclcommand="xschem raw_read $netlist_dir/tb_PLL_div_model.raw tran"
}
...
C {lab_wire.sym} 700 -1500 0 0 {name=p12 sig_type=std_logic lab=reference}
C {code_shown.sym} -1010 -1590 0 0 {name=MODELS only_toplevel=true
...
"}
C {devices/code_shown.sym} -1005 -1188.75 0 0 {name=Simulation only_toplevel=false value="
.options method=gear
VDD VDD 0 3.3
...
*save all
save v(vco_out) v(reference) v(up) v(dn) v(tune) v(pre_div) v(div_out)
TRAN 10n 200u
remzerovec

write tb_PLL_div_model.raw
wrdata /foss/designs/synchronos-chipathon-2026/designs/libs/scripts/sim_data/tb_PLL_div_model.txt tran.all
.endc
"}
C {libs/core_analog/pulse_swallow_div/src/pulse_swallow_div.sym} 970 -1230 0 1 {name=x7}
C {libs/model_pll/pfd_model.sym} 780 -1470 0 0 {name=x6}
C {vsource.sym} 620 -1270 2 0 {name=V3 value="PWL(0 0 10n 0 10.1n 3.3)" savecurrent=false}
C {gnd.sym} 590 -1300 0 0 {name=l4 lab=0}
C {lab_wire.sym} 1150 -1310 0 1 {name=p15 sig_type=std_logic lab=rst
}
C {lab_wire.sym} 970 -1370 0 0 {name=p16 sig_type=std_logic lab=VDD}
C {lab_wire.sym} 970 -1090 0 0 {name=p17 sig_type=std_logic lab=GND}
C {lab_wire.sym} 640 -1360 0 1 {name=p19 sig_type=std_logic lab=rst}
C {lab_pin.sym} 1130 -1130 0 1 {name=p4 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 1130 -1230 0 1 {name=p13 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 1130 -1170 0 1 {name=p14 sig_type=std_logic lab=GND}
C {lab_pin.sym} 1130 -1270 0 1 {name=p18 sig_type=std_logic lab=GND}
