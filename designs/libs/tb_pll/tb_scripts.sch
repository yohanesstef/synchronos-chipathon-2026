...
==============Frequency Calculation========
.param tp_ref='td_ref/2' td_ref='1/f_ref'
Vref reference gnd pulse(0 3.3 0 400p 400p tp_ref td_ref)
...
write tb2_7.raw
wrdata /foss/designs/synchronos-chipathon-2026/designs/libs/scripts/sim_data/tb2_7.txt tran.all

.endc
"}
C {devices/code_shown.sym} 205 -840 0 0 {name=tb3 only_toplevel=false value="
==============Fref, N======================
...
write tb3_2.raw
wrdata /foss/designs/synchronos-chipathon-2026/designs/libs/scripts/sim_data/tb3_2.txt tran.all
