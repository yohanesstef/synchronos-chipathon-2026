...
module tb_pulse_swallow_div;
    ...
    initial begin
        ...
        $dumpvars(0, tb_pulse_swallow_div);
        ...
        // Let it run for enough time to see several 10 MHz cycles
        // 10 MHz period is 100 ns, so 1000 ns gives us 10 full cycles
        #1000;
    ...
    always @(posedge clk_out) begin
        if (last_edge_time > 0) begin
            ...
            // Flag an error if the frequency isn't exactly 10 MHz
